...
class School(ABC): # Abstract class
    @abstractmethod
    def display(self): #Abstract method to display details
        pass
...
class Class(School): #Parent Class inheriting from School
    ...
    def update_details(self, section_name=None, class_teacher_name=None): #Update class details
        if section_name:
            self.section_name = section_name
...
class Students(Class): #Child class inheriting from Class
    ...
    def display(self): #Display student and class details
